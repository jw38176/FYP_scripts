...
set terminal pngcairo size 2800,3500
...
plot '{results_folder}/{result}/{result}.dat' using 2:xtic(1) title 'IPC' axes x1y1 linecolor rgb "#5397d4", '' using 3:xtic(1) title 'Coverage' axes x1y2 linecolor rgb "#d9534f"
\n"""
