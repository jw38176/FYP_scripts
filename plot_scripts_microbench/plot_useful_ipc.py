...
for i, result in enumerate(folders):
    ...
    result_name = result.replace("_", "\\\_")

    plot_script += f"""
set title "{result_name}" 
plot '{results_folder}/{result}/{result}.dat' using 2:xtic(1) title 'IPC' axes x1y1 linecolor rgb "#5397d4", '' using 3:xtic(1) title 'useful' axes x1y2 linecolor rgb "#d9534f"
\n"""
