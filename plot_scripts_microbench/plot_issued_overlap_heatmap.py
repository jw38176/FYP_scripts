...
for test_folder in os.listdir(benchmark_folder):
    ...
    if os.path.isdir(test_folder_path):
        ...
        for file_name in os.listdir(test_folder_path):
            if file_name.endswith('_issued_percentage.txt'):
...
df.to_csv(os.path.join(benchmark_folder, "overlap.dat"), sep='\t')
...
plt.savefig(os.path.join(benchmark_folder, "overlap_heatmap.png"))
