...
results_folder = "/home/jw38176/gem5/jw38176/results/microbench_ctour"
...
# Generate dat file
with open(os.path.join(results_folder, f"cache_window.dat"), "w+") as file:
    file.write(dat_file_data)

# Generate plot script
plot_script = f"""
set terminal pngcairo size 500, 500
set output '{results_folder}/cache_window.png'
...
set ylabel "IPC"
set xlabel "Cache Window Size"

plot '{results_folder}/cache_window.dat' using 2:xtic(1) linecolor rgb "#0080ff"

"""

# Save plot script to file
with open(f"{results_folder}/plot_cache_window.gp", "w+") as file:
    file.write(plot_script)

# Call gnuplot
os.system(f"gnuplot {results_folder}/plot_cache_window.gp")
