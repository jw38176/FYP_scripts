...
highlight_prefetcher = "CTour"  # The prefetcher to highlight
highlight_color = "#ff0000"  # Color for the highlighted prefetcher
default_color = "#5397d4"  # Default color for other prefetchers
...
for result in folders:
    ...
    plot_script += f"""
set title "{result}"
plot '{results_folder}/{result}/{result}.dat' using (column(0)):2:(0.5):($3>0?5:3):xtic(1) with boxes lc variable
\n"""
