...
parser.add_argument('--resultdir',
    type=str,
    default="/home/jw38176/gem5/jw38176/results/coremark",
...
workload_path = os.path.join(COREMARK_PATH, coremark_benchmarks[args.benchmark])
benchopts = ' '.join(coremark_args)

run_commands = []

for prefetcher in prefetchers:

    result_dir = f"{args.resultdir}/{args.benchmark}/{prefetcher}"
    ...
    if args.log:
        run_command.extend(['--debug-flags=PrefetchAddr'])
