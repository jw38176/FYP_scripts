...
# This script runs all the prefetchers in parallel for all tests in microbench 
...
parser.add_argument('--resultdir',
    type=str,
    default="/home/jw38176/gem5/jw38176/results/microbench",
...
# Find all directories in the microbench directory
workload_paths = [
...
for workload in workload_paths:
    ...
    for prefetcher in prefetchers:
        ...
        result_dir = f"{args.resultdir}/{workload}/{prefetcher}"
